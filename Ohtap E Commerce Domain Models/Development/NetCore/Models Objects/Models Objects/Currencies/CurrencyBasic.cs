...
{
    public class CurrencyBasic : Objecta, ICurrencyData
    {
        private string _ID;
        ...
        IDataItemList<IDataItemData> ICurrencyData.Dataset { get { return this.Dataset as IDataItemList<IDataItemData>; } set { this.Dataset = (DataItemList)value; } }

        public CurrencyBasic()
        {
