...
{
    public class OptionBasic :Objecta, IOptionData
    {
        ...
        IDataItemList<IDataItemData> IOptionData.Dataset { get { return this.Dataset as IDataItemList<IDataItemData>; } set { this.Dataset = (DataItemList)value; } }
