...
{
    public class MeasureDetailBasic :Objecta, IMeasureDetailData
    {
        ...
        IDataItemList<IDataItemData> IMeasureDetailData.Dataset { get { return this.Dataset as IDataItemList<IDataItemData>; } set { this.Dataset = (DataItemList)value; } }

        

        public MeasureDetailBasic()
        {
