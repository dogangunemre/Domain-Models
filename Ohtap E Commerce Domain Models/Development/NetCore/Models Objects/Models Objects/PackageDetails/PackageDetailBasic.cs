...
{
    public class PackageDetailBasic :Objecta, IPackageDetailData
    {
        ...
        IDataItemList<IDataItemData> IPackageDetailData.Dataset { get { return this.Dataset as IDataItemList<IDataItemData>; } set { this.Dataset = (DataItemList)value; } }

        public PackageDetailBasic()
        {
