...
{
    public class PromotionDetailBasic :Objecta, IPromotionDetailData
    {
        private string _ID;
        ...
        IDataItemList<IDataItemData> IPromotionDetailData.Dataset { get { return this.Dataset as IDataItemList<IDataItemData>; } set { this.Dataset = (DataItemList)value; } }

        public PromotionDetailBasic()
        {
