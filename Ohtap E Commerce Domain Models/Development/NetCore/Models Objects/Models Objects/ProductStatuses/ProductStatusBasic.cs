...
{
    public class ProductStatusBasic :Objecta, IProductStatusData
    {
        private string _ID;
        ...
        IDataItemList<IDataItemData> IProductStatusData.Dataset { get { return this.Dataset as IDataItemList<IDataItemData>; } set { this.Dataset = (DataItemList)value; } }

        public ProductStatusBasic()
        {
