...
{
    public class PropertyDetailBasic :Objecta, IPropertyDetailData
    {
        private string _ID;
        ...
        IDataItemList<IDataItemData> IPropertyDetailData.Dataset { get { return this.Dataset as IDataItemList<IDataItemData>; } set { this.Dataset = (DataItemList)value; } }

        public PropertyDetailBasic()
        {
