...
{
    public class RegionBasic :Objecta, IRegionData
    {
        private string _ID;
        ...
        private RegionBasic _Parent;
        public virtual RegionBasic Parent { get => base.GetProperty(this._Parent); set => base.SetProperty(ref this._Parent, value); }
        IRegionData IRegionData.Parent { get { return this.Parent as IRegionData; } set { this.Parent = (RegionBasic)value; } }
        ...
        IDataItemList<IDataItemData> IRegionData.Dataset { get { return this.Dataset as IDataItemList<IDataItemData>; } set { this.Dataset = (DataItemList)value; } }
