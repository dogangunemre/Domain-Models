...
{
    public class ProductOptionBasic :Objecta, IProductOptionData
    {
        private string _ID;
        ...
        IOptionData IProductOptionData.Option { get { return this.Option as IOption; } set { this.Option = (Option)value; } }
        ...
        IDataItemList<IDataItemData> IProductOptionData.Dataset { get { return this.Dataset as IDataItemList<IDataItemData>; } set { this.Dataset = (DataItemList)value; } }

        public ProductOptionBasic()
        {
