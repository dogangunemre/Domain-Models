...
{
    public class SettingBasic :Objecta, ISettingData
    {
        ...
        IDataItemList<IDataItemData> ISettingData.Dataset { get { return this.Dataset as IDataItemList<IDataItemData>; } set { this.Dataset = (DataItemList)value; } }
