...
{
    public class StoreBasic :Objecta, IStoreData
    {
        private string _ID;
        ...
        IDataItemList<IDataItemData> IStoreData.Dataset { get { return this.Dataset as IDataItemList<IDataItemData>; } set { this.Dataset = (DataItemList)value; } }
