...
{
    public class SupplierBasic :Objecta, ISupplierData
    {
        ...
        IDataItemList<IDataItemData> ISupplierData.Dataset { get { return this.Dataset as IDataItemList<IDataItemData>; } set { this.Dataset = (DataItemList)value; } }
