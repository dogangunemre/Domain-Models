...
{
    public class ProductCategoryBasic :Objecta, IProductCategoryData
    {
        private string _ID;
        ...
        public virtual ProductCategory Parent { get => base.GetProperty(this._Parent); set => base.SetProperty(ref this._Parent, value); }
        IProductCategoryData IProductCategoryData.Parent { get { return this.Parent as IProductCategoryData; } set { this.Parent = (ProductCategory)value; } }

        private File _Photo;
        public virtual File Photo { get => base.GetProperty(this._Photo); set => base.SetProperty(ref this._Photo, value); }
        IFileData IProductCategoryData.Photo { get { return this.Photo as IFileData; } set { this.Photo = (File)value; } }
        ...
        IDataItemList<IDataItemData> IProductCategoryData.Dataset { get { return this.Dataset as IDataItemList<IDataItemData>; } set { this.Dataset = (DataItemList)value; } }

        public ProductCategoryBasic()
        {
