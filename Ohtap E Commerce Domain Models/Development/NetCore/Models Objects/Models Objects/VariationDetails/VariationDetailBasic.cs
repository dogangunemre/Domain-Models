...
{
    public class VariationDetailBasic :Objecta, IVariationDetailData
    {
        ...
        IDataItemList<IDataItemData> IVariationDetailData.Dataset { get { return this.Dataset as IDataItemList<IDataItemData>; } set { this.Dataset = (DataItemList)value; } }

        public VariationDetailBasic()
        {
