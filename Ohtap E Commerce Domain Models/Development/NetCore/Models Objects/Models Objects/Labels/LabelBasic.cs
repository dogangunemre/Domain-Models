...
{
    public class LabelBasic :Objecta, ILabelData
    {
        private string _ID;
        ...
        IDataItemList<IDataItemData> ILabelData.Dataset { get { return this.Dataset as IDataItemList<IDataItemData>; } set { this.Dataset = (DataItemList)value; } }
