...
{
    public class SpecificationDetailBasic :Objecta, ISpecificationDetailData
    {
        private string _ID;
        ...
        IDataItemList<IDataItemData> ISpecificationDetailData.Dataset { get { return this.Dataset as IDataItemList<IDataItemData>; } set { this.Dataset = (DataItemList)value; } }

        public SpecificationDetailBasic()
        {
