...
{
    public class LanguageBasic :Objecta, ILanguageData
    {
        private string _ID;
        ...
        IDataItemList<IDataItemData> ILanguageData.Dataset { get { return this.Dataset as IDataItemList<IDataItemData>; } set { this.Dataset = (DataItemList)value; } }
