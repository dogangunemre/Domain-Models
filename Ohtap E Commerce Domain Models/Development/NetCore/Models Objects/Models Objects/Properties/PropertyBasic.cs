...
{
    public class PropertyBasic :Objecta, IPropertyData
    {
        private string _ID;
        ...
        public virtual DataTypes DataType { get => base.GetProperty(this._DataType); set => base.SetProperty(ref this._DataType, value); }
        ...
        IDataItemList<IDataItemData> IPropertyData.Dataset { get { return this.Dataset as IDataItemList<IDataItemData>; } set { this.Dataset = (DataItemList)value; } }
