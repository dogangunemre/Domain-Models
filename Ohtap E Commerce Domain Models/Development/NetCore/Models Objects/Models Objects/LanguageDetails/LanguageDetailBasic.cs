...
{
    public class LanguageDetailBasic :Objecta, ILanguageDetailData
    {
        private string _ID;
        ...
        public virtual string LanguageCode { get => base.GetProperty(this._LanguageCode); set => base.SetProperty(ref this._LanguageCode, value); }
        ...
        IDataItemList<IDataItemData> ILanguageDetailData.Dataset { get { return this.Dataset as IDataItemList<IDataItemData>; } set { this.Dataset = (DataItemList)value; } }

        public LanguageDetailBasic()
        {
