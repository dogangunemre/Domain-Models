...
{
    public class PackageAttributeDetailBasic :Objecta, IPackageAttributeDetailData
    {
        private string _ID;
        ...
        IDataItemList<IDataItemData> IPackageAttributeDetailData.Dataset { get { return this.Dataset as IDataItemList<IDataItemData>; } set { this.Dataset = (DataItemList)value; } }

        public PackageAttributeDetailBasic()
        {
