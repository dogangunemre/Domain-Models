...
{
    public class ProductGroupDetailBasic :Objecta, IProductGroupDetailData
    {
        private string _ID;
        ...
        IDataItemList<IDataItemData> IProductGroupDetailData.Dataset { get { return this.Dataset as IDataItemList<IDataItemData>; } set { this.Dataset = (DataItemList)value; } }

        public ProductGroupDetailBasic()
        {
