...
{
    public class AttributeDetailBasic :Objecta, IAttributeDetailData
    {
        private string _ID;
        ...
        IDataItemList<IDataItemData> IAttributeDetailData.Dataset { get { return this.Dataset as IDataItemList<IDataItemData>; } set { this.Dataset = (DataItemList)value; } }

        public AttributeDetailBasic()
        {
