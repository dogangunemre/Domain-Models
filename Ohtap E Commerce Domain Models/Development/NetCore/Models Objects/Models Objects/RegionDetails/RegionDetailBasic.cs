...
{
    public class RegionDetailBasic :Objecta, IRegionDetailData
    {
        private string _ID;
        ...
        IDataItemList<IDataItemData> IRegionDetailData.Dataset { get { return this.Dataset as IDataItemList<IDataItemData>; } set { this.Dataset = (DataItemList)value; } }

        public RegionDetailBasic()
        {
