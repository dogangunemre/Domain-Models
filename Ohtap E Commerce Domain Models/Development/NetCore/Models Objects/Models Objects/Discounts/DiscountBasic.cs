...
{
    public class DiscountBasic : Objecta, IDiscountData
    {
        private string _ID;
        ...
        IDataItemList<IDataItemData> IDiscountData.Dataset { get { return this.Dataset as IDataItemList<IDataItemData>; } set { this.Dataset = (DataItemList)value; } }

        public DiscountBasic()
        {
