...
{
    public class CargoStatusBasic :Objecta, ICargoStatusData
    {
        private string _ID;
        ...
        IDataItemList<IDataItemData> ICargoStatusData.Dataset { get { return this.Dataset as IDataItemList<IDataItemData>; } set { this.Dataset = (DataItemList)value; } }

        public CargoStatusBasic()
        {
