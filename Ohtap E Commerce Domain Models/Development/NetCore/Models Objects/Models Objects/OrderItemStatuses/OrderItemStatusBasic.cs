...
{
    public class OrderItemStatusBasic :Objecta, IOrderItemStatusData
    {
        private string _ID;
        ...
        IDataItemList<IDataItemData> IOrderItemStatusData.Dataset { get { return this.Dataset as IDataItemList<IDataItemData>; } set { this.Dataset = (DataItemList)value; } }

        public OrderItemStatusBasic()
        {
