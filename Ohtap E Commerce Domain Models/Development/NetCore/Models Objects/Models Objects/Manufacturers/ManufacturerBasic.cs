...
{
    public class ManufacturerBasic :Objecta, IManufacturerData
    {
        private string _ID;
        ...
        IDataItemList<IDataItemData> IManufacturerData.Dataset { get { return this.Dataset as IDataItemList<IDataItemData>; } set { this.Dataset = (DataItemList)value; } }

        public ManufacturerBasic()
        {
