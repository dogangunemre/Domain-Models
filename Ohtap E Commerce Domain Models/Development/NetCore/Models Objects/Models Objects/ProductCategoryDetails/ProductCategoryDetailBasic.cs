...
{
    public class ProductCategoryDetailBasic :Objecta, IProductCategoryDetailData
    {
        ...
        IDataItemList<IDataItemData> IProductCategoryDetailData.Dataset { get { return this.Dataset as IDataItemList<IDataItemData>; } set { this.Dataset = (DataItemList)value; } }

        public ProductCategoryDetailBasic()
        {
