...
{
    public class RelationBasic :Objecta, IRelationData
    {
        private string _ID;
        ...
        IDataItemList<IDataItemData> IRelationData.Dataset { get { return this.Dataset as IDataItemList<IDataItemData>; } set { this.Dataset = (DataItemList)value; } }
