...
{
    public class CouponDetailBasic :Objecta, ICouponDetailData
    {
        private string _ID;
        ...
        IDataItemList<IDataItemData> ICouponDetailData.Dataset { get { return this.Dataset as IDataItemList<IDataItemData>; } set { this.Dataset = (DataItemList)value; } }

        public CouponDetailBasic()
        {
