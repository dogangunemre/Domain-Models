...
{
    public class TagBasic :Objecta, ITagData
    {
        private string _ID;
        ...
        IDataItemList<IDataItemData> ITagData.Dataset { get { return this.Dataset as IDataItemList<IDataItemData>; } set { this.Dataset = (DataItemList)value; } }
        public TagBasic()
        {
