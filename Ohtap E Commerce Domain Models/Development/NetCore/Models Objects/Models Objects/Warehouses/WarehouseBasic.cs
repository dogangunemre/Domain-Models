...
{
    public class WarehouseBasic : Objecta, IWarehouseData
    {
        private string _ID;
        ...
        StoreBasic IWarehouseData.Store { get { return this.Store as StoreBasic; } set { this.Store = (Store)value; } }
        ...
        IDataItemList<IDataItemData> IWarehouseData.Dataset { get { return this.Dataset as IDataItemList<IDataItemData>; } set { this.Dataset = (DataItemList)value; } }

       

        public WarehouseBasic()
        {
