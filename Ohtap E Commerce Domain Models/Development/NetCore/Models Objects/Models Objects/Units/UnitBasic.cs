...
{
    public class UnitBasic :Objecta, IUnitData
    {
        private string _ID;
        ...
        IDataItemList<IDataItemData> IUnitData.Dataset { get { return this.Dataset as IDataItemList<IDataItemData>; } set { this.Dataset = (DataItemList)value; } }
