...
{
    public class CustomerGroupDetailBasic :Objecta, ICustomerGroupDetailData
    {
        private string _ID;
        ...
        IDataItemList<IDataItemData> ICustomerGroupDetailData.Dataset { get { return this.Dataset as IDataItemList<IDataItemData>; } set { this.Dataset = (DataItemList)value; } }

        public CustomerGroupDetailBasic()
        {
