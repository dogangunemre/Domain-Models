...
{
    public class CurrencyDetailBasic :Objecta, ICurrencyDetailData
    {
        ...
        IDataItemList<IDataItemData> ICurrencyDetailData.Dataset { get { return this.Dataset as IDataItemList<IDataItemData>; } set { this.Dataset = (DataItemList)value; } }

        public CurrencyDetailBasic()
        {
