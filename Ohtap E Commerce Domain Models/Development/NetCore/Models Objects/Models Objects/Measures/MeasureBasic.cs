...
{
    public class MeasureBasic :Objecta,IMeasureData
    {
        private string _ID;
        ...
        IDataItemList<IDataItemData> IMeasureData.Dataset { get { return this.Dataset as IDataItemList<IDataItemData>; } set { this.Dataset = (DataItemList)value; } }
