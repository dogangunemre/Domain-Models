...
{
    public class AttributeBasic : Objecta, IAttributeData
    {
        private string _ID;
        ...
        IDataItemList<IDataItemData> IAttributeData.Dataset { get { return this.Dataset as IDataItemList<IDataItemData>; } set { this.Dataset = (DataItemList)value; } }

        

        public AttributeBasic()
        {
