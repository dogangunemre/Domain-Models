...
{
    public class DiscountDetailBasic :Objecta, IDiscountDetailData
    {
        private string _ID;
        ...
        IDataItemList<IDataItemData> IDiscountDetailData.Dataset { get { return this.Dataset as IDataItemList<IDataItemData>; } set { this.Dataset = (DataItemList)value; } }

        

        public DiscountDetailBasic()
        {
