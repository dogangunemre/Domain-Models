...
{
    public class SpecificationBasic :Objecta, ISpecificationData
    {
        private string _ID;
        ...
        IDataItemList<IDataItemData> ISpecificationData.Dataset { get { return this.Dataset as IDataItemList<IDataItemData>; } set { this.Dataset = (DataItemList)value; } }

        public SpecificationBasic()
        {
