...
{
    public class OrderStatusBasic :Objecta, IOrderStatusData
    {
        private string _ID;
        ...
        IDataItemList<IDataItemData> IOrderStatusData.Dataset { get { return this.Dataset as IDataItemList<IDataItemData>; } set { this.Dataset = (DataItemList)value; } }

        public OrderStatusBasic()
        {
