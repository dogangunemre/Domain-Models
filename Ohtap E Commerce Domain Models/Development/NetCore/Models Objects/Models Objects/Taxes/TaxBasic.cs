...
{
    public class TaxBasic :Objecta, ITaxData
    {
        private string _ID;
        ...
        public virtual RegionBasic Region { get => base.GetProperty(this._Region); set => base.SetProperty(ref this._Region, value); }
        IRegionData ITaxData.Region { get { return this.Region; } set { this.Region = (RegionBasic)value; } }
        ...
        IDataItemList<IDataItemData> ITaxData.Dataset { get { return this.Dataset as IDataItemList<IDataItemData>; } set { this.Dataset = (DataItemList)value; } }
