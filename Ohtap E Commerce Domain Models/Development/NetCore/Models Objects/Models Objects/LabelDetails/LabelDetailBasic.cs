...
{
    public class LabelDetailBasic :Objecta, ILabelDetailData
    {
        private string _ID;
        ...
        IDataItemList<IDataItemData> ILabelDetailData.Dataset { get { return this.Dataset as IDataItemList<IDataItemData>; } set { this.Dataset = (DataItemList)value; } }

        public LabelDetailBasic()
        {
