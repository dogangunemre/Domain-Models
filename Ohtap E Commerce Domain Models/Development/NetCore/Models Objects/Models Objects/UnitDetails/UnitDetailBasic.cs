...
{
    public class UnitDetailBasic :Objecta, IUnitDetailData
    {
        private string _ID;
        ...
        IDataItemList<IDataItemData> IUnitDetailData.Dataset { get { return this.Dataset as IDataItemList<IDataItemData>; } set { this.Dataset = (DataItemList)value; } }

        public UnitDetailBasic()
        {
