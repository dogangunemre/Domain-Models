...
{
    public class ProductDetailBasic :Objecta, IProductDetailData
    {
        private string _ID;
        ...
        IDataItemList<IDataItemData> IProductDetailData.Dataset { get { return this.Dataset as IDataItemList<IDataItemData>; } set { this.Dataset = (DataItemList)value; } }
