...
{
    public class TagDetailBasic :Objecta, ITagDetailData
    {
        private string _ID;
        ...
        IDataItemList<IDataItemData> ITagDetailData.Dataset { get { return this.Dataset as IDataItemList<IDataItemData>; } set { this.Dataset = (DataItemList)value; } }

        public TagDetailBasic()
        {
