...
{
    public class PaymentStatusBasic :Objecta, IPaymentStatusData
    {
        private string _ID;
        ...
        IDataItemList<IDataItemData> IPaymentStatusData.Dataset { get { return this.Dataset as IDataItemList<IDataItemData>; } set { this.Dataset = (DataItemList)value; } }

        public PaymentStatusBasic()
        {
