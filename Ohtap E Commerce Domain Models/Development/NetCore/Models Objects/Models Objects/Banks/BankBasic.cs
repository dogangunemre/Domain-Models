...
{
    public class BankBasic :Objecta, IBankData
    {
        ...
        IDataItemList<IDataItemData> IBankData.Dataset { get { return this.Dataset as IDataItemList<IDataItemData>; } set { this.Dataset = (DataItemList)value; } }
