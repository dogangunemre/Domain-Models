...
{
    public class PaymentMethodBasic :Objecta, IPaymentMethodData
    {
        private string _ID;
        ...
        IDataItemList<IDataItemData> IPaymentMethodData.Dataset { get { return this.Dataset as IDataItemList<IDataItemData>; } set { this.Dataset = (DataItemList)value; } }

        public PaymentMethodBasic()
        {
