...
{
    public class OptionDetailBasic :Objecta, IOptionDetailData
    {
        ...
        IDataItemList<IDataItemData> IOptionDetailData.Dataset { get { return this.Dataset as IDataItemList<IDataItemData>; } set { this.Dataset = (DataItemList)value; } }

        public OptionDetailBasic()
        {
